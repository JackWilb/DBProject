...
width=`identify -format %w ~/websites/DBProject/src/static/MemeGenerator/willyWonka.jpg`;   convert -background '#0008' -fill white -font Impact -gravity center -size ${width}x30 caption:"Tell me about how well you're balancing your time"  ~/websites/DBProject/src/media/MemeGenerator/temp.jpg +swap -gravity south -composite ~/websites/DBProject/src/media/MemeGenerator/admin3.jpg

width=`identify -format %w ~/websites/DBProject/src/static/MemeGenerator/obama.jpg`;   convert -background '#0008' -fill white -font Impact -gravity center -size ${width}x30 caption:"When you see your replacement..."  ~/websites/DBProject/src/static/MemeGenerator/obama.jpg +swap -gravity north -composite ~/websites/DBProject/src/media/MemeGenerator/admin4.jpg
