...
def makeameme(request):
	if request.method == 'POST':
		...
		command2 = "width=`identify -format %w " + file_path_root + "media/MemeGenerator/temp.jpg`;   convert -background '#0008' -fill white -font Impact -gravity center -size ${width}x30 caption:'" + str(bottomText) + "' rickAstley.jpg +swap -gravity south -composite  " + file_path_root + "media/MemeGenerator/" + str(random_file_number) + ".jpg"
		os.system(command1)
		os.system(command2)
